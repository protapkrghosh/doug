...
const BirthLegend = () => {
  return (
    <div className='overflow-hidden mt-14 md:mt-[175px] lg:mb-[75px] lg:pb-16 xl:pb-0'>
      <Container>
        <h1 className='text-[#111] text-[28px] md:text-[60px] xl:text-[75px] text-center font-montserrat font-bold textShadowSm md:textShadow mb-16'>BIRTH OF A LEGEND</h1>
        ...
        <div className='flex flex-col-reverse lg:flex-row justify-between items-center'>
          ...
          <div className='lg:w-1/2 relative -mt-14 lg:mt-0'>
            <div>
              <h1 className='text-[24px] md:text-[45px] xl:text-[55px] 2xl:text-[65px] text-center md:text-start font-montserrat textShadowSm md:textShadow font-bold md:leading-[80px] w-[80%] md:w-full mx-auto'>Meet Doug – Pug Perfection</h1>
