        ...
        <div className='relative'>
          ...
          <div>
            ...
            <div>
              {/* botton posigition  */}
              {/* Pump to the Moon */}
              <p className='2xl:left-[171px] xl:left-[140px] lg:left-[142px] md:left-[80px] left-[59px] 2xl:bottom-[50px] xl:bottom-[39px] lg:bottom-[32px] md:bottom-[89px] bottom-[59px] absolute w-fit bg-[#EEB10E] xl:px-[20px] lg:px-[10px] md:px-5 px-2 2xl:py-[15px] xl:py-[12px] lg:py-[5px] md:py-2 py-1 rounded-full text-[#FFF] font-karla text-[13px] md:text-[16px] xl:text-[18px] lg:text-[12px] leading-[27px] rotate-[10deg] lg:rotate-0'>Pump to the Moon</p>

              {/* Worldwide Popularity */}
              <p className='2xl:left-[368px] xl:left-[303px] lg:left-[265px] md:left-[135px] left-[93px] 2xl:bottom-[135px] xl:bottom-[107px] lg:bottom-[82px] md:bottom-[143px] bottom-[96px] absolute w-fit bg-[#EEB10E] xl:px-[20px] lg:px-[10px] md:px-5 px-2 2xl:py-[15px] xl:py-[12px] lg:py-[5px] md:py-2 py-1 rounded-full text-[#FFF] font-karla text-[13px] md:text-[16px] xl:text-[18px] lg:text-[12px] leading-[27px] rotate-[10deg] lg:rotate-0'>Worldwide Popularity</p>

              {/* King-Sized */}
              <p className='2xl:left-[508px] xl:left-[418px] lg:left-[350px] md:left-[163px] left-[115px] 2xl:bottom-[215px] xl:bottom-[173px] lg:bottom-[132px] md:bottom-[203px] bottom-[138px] absolute w-fit bg-[#EEB10E] xl:px-[20px] lg:px-[10px] md:px-5 px-2 2xl:py-[15px] xl:py-[12px] lg:py-[5px] md:py-2 py-1 rounded-full text-[#FFF] font-karla text-[13px] md:text-[16px] xl:text-[18px] lg:text-[12px] leading-[27px] rotate-[10deg] lg:rotate-0'>King-Sized Community</p>

              {/* Marketcap Milestone */}
              <p className='2xl:left-[660px] xl:left-[543px] lg:left-[443px] md:left-[210px] left-[145px] 2xl:bottom-[298px] xl:bottom-[241px] lg:bottom-[182px] md:bottom-[260px] bottom-[179px] absolute w-fit bg-[#EEB10E] xl:px-[20px] lg:px-[10px] md:px-5 px-2 2xl:py-[15px] xl:py-[12px] lg:py-[5px] md:py-2 py-1 rounded-full text-[#FFF] font-karla text-[13px] md:text-[16px] xl:text-[18px] lg:text-[12px] leading-[27px] rotate-[10deg] lg:rotate-0'>$1B Marketcap Milestone</p>

              {/* DougCoin Dominance */}
              <p className='2xl:left-[779px] xl:left-[641px] lg:left-[510px] md:left-[243px] left-[169px] 2xl:bottom-[379px] xl:bottom-[307px] lg:bottom-[233px] md:bottom-[323px] bottom-[222px] absolute w-fit bg-[#EEB10E] xl:px-[20px] lg:px-[10px] md:px-5 px-2 2xl:py-[15px] xl:py-[12px] lg:py-[5px] md:py-2 py-1 rounded-full text-[#FFF] font-karla text-[13px] md:text-[16px] xl:text-[18px] lg:text-[12px] leading-[27px] rotate-[10deg] lg:rotate-0'>DougCoin Dominance</p>

              {/* Meme Coin Takeover */}
              <p className='2xl:left-[955px] xl:left-[786px] lg:left-[625px] md:left-[283px] left-[200px] 2xl:bottom-[459px] xl:bottom-[375px] lg:bottom-[284px] md:bottom-[382px] bottom-[263px] absolute w-fit bg-[#EEB10E] xl:px-[20px] lg:px-[10px] md:px-5 px-2 2xl:py-[15px] xl:py-[12px] lg:py-[5px] md:py-2 py-1 rounded-full text-[#FFF] font-karla text-[13px] md:text-[16px] xl:text-[18px] lg:text-[12px] leading-[27px] rotate-[10deg] lg:rotate-0'>Meme Coin Takeover</p>

              {/* Reign Forever */}
              <p className='2xl:left-[1095px] xl:left-[902px] lg:left-[713px] md:left-[325px] left-[228px] 2xl:bottom-[540px] xl:bottom-[441px] lg:bottom-[335px] md:bottom-[445px] bottom-[308px] absolute w-fit bg-[#EEB10E] xl:px-[20px] lg:px-[10px] md:px-5 px-2 2xl:py-[15px] xl:py-[12px] lg:py-[5px] md:py-2 py-1 rounded-full text-[#FFF] font-karla text-[13px] md:text-[16px] xl:text-[18px] lg:text-[12px] leading-[27px] rotate-[10deg] lg:rotate-0'>Reign Forever</p>
            </div>
