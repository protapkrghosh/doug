      ...
      <Container>
        <div className='lg:flex justify-center items-center relative'>
          ...
          <div className='xl:w-3/5 lg:w-1/2'>
            ...
            <div>
              <p className='2xl:text-[80px] xl:text-[67px] lg:text-[45px] md:text-[60px] text-[28px] text-[#111] textShadow font-montserrat font-bold leading-[96px] xl:tracking-[1.6px]'>1% BUY & SELL FEE</p>

              <p className='lg:text-[20px] md:mt-[25px] mt-[10px] md:mb-[50px] mb-[24px] text-[#333131] font-karla font-medium leading-[30px] 2xl:max-w-[688px] xl:w-[665px]'>Doug’s itsy-bitsy fee can potentially elevate the investment experience and outcomes. With redistribution to liquidity, marketing, and burning, the aim is to bolster a more robust and sustainable ecosystem for $DOUG meme coin buyers.</p>
          ...
          <div className='xl:w-2/5 lg:w-1/2'>
