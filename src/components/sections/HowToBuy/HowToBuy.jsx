            ...
            <div>
              ...
              <div>
                ...
                <div className='block 2xl:hidden'>
                  ...
                  <img src={lineImg} alt="Image" className='absolute xl:left-[16px] md:left-[17px] xl:top-[203px] lg:top-[226px] md:top-[200px] xl:w-4 lg:w-4 md:w-[13px] xl:h-[100px] lg:h-[125px] md:h-[78px]' />
                </div>
              </div>
