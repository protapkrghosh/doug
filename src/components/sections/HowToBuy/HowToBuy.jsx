            ...
            <div>
              ...
              <div>
                ...
                <div className='block 2xl:hidden'>
                  <img src={lineImg} alt="Image" className='absolute xl:left-[16px] md:left-[17px] left-[12px] xl:top-[43px] lg:top-[47px] md:top-[50px] top-[43px] xl:w-4 lg:w-4 md:w-[13px] xl:h-[115px] lg:h-[135px] md:h-[109px] h-[117px]' />
                  <img src={lineImg} alt="Image" className='absolute xl:left-[16px] md:left-[17px] left-[12px] xl:top-[203px] lg:top-[226px] md:top-[200px] top-[200px] xl:w-4 lg:w-4 md:w-[13px] xl:h-[100px] lg:h-[125px] md:h-[78px] h-[112px]' />
                </div>
              </div>
